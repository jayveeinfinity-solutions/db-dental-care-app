                    ...
                    <div class="col-lg-4 col-md-6 mb-sm-30">
                        <div class="d-flex justify-content-center">
                            ...
                            <div class="ms-3">
                                ...
                                <p><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="c8aba7a6bca9abbc88acada6bca1a9aba4a1a6a1abe6aba7a5">[email&#160;protected]</a></p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row g-4">
                                <div class="col-lg-12">
                                    <div class=" rounded-1 overflow-hidden wow zoomIn">
                                        <img src="https://madebydesignesia.com/themes/dentia/images/misc/p1.webp" class="w-100 wow scaleIn" alt="">
                                    </div>
                                </div>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-lg-12">
                                    <div class=" rounded-1 overflow-hidden wow zoomIn" data-wow-delay=".3s">
                                        <img src="https://madebydesignesia.com/themes/dentia/images/misc/p2.webp" class="w-100 wow scaleIn" alt="" data-wow-delay=".3s">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    <div class="col-lg-3 col-sm-6">
                        <div class="hover">
                            <div class="bg-white h-100 p-40 rounded-1">
                                <img src="https://madebydesignesia.com/themes/dentia/images/icons/tooth-1.png" class="w-70px mb-3 wow scaleIn" alt="">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="hover">
                            <div class="bg-white h-100 p-40 rounded-1">
                                <img src="https://madebydesignesia.com/themes/dentia/images/icons/tooth-2.png" class="w-70px mb-3 wow scaleIn" alt="">
                                <div class="relative mt-4 wow fadeInUp">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="hover">
                            <div class="bg-white h-100 p-40 rounded-1">
                                <img src="https://madebydesignesia.com/themes/dentia/images/icons/tooth-3.png" class="w-70px mb-3 wow scaleIn" alt="">
                                <div class="relative mt-4 wow fadeInUp">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="hover">
                            <div class="bg-white h-100 p-40 rounded-1">
                                <img src="https://madebydesignesia.com/themes/dentia/images/icons/tooth-4.png" class="w-70px mb-3 wow scaleIn" alt="">
                                <div class="relative mt-4 wow fadeInUp">
                        ...
                        <div class="row g-4 align-items-center">
                            <div class="col-6 text-end">
                                <div class="w-80 rounded-1 overflow-hidden mb-25 wow zoomIn d-inline-block">
                                    <img src="https://madebydesignesia.com/themes/dentia/images/misc/s2.webp" class="w-100 wow scaleIn" alt="">
                                </div>
                                <div class="w-100 rounded-1 overflow-hidden mb-25 wow zoomIn d-inline-block">
                                    <img src="https://madebydesignesia.com/themes/dentia/images/misc/s3.webp" class="w-100 wow scaleIn" alt="">
                                </div>
                            </div>

                            <div class="col-6">
                                <div class="w-100 rounded-1 overflow-hidden mb-25 wow zoomIn d-inline-block">
                                    <img src="https://madebydesignesia.com/themes/dentia/images/misc/p3.webp" class="w-100 wow scaleIn" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    <div class="col-lg-3 col-md-6">
                        <div class="relative rounded-1 overflow-hidden">
                            <div class="rounded-1 overflow-hidden wow fadeIn zoomIn">
                                <img src="https://madebydesignesia.com/themes/dentia/images/team/1.webp" class="w-100 wow scaleIn" alt="">
                            </div>                                
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="relative rounded-1 overflow-hidden">
                            <div class="rounded-1 overflow-hidden wow fadeIn zoomIn">
                                <img src="https://madebydesignesia.com/themes/dentia/images/team/2.webp" class="w-100 wow scaleIn" alt="">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="relative rounded-1 overflow-hidden">
                            <div class="rounded-1 overflow-hidden wow fadeIn zoomIn">
                                <img src="https://madebydesignesia.com/themes/dentia/images/team/3.webp" class="w-100 wow scaleIn" alt="">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="relative rounded-1 overflow-hidden">
                            <div class="rounded-1 overflow-hidden wow fadeIn zoomIn">
                                <img src="https://madebydesignesia.com/themes/dentia/images/team/4.webp" class="w-100 wow scaleIn" alt="">
                            </div>
                            ...
                            <div class="gradient-white-top p-40 py-4 rounded-1">
                                <blockquote>
                                    ...
                                    <div class="de_testi_by">
                                        <img class="circle" alt="" src="https://madebydesignesia.com/themes/dentia/images/testimonial/1.webp"> <div>Michael S.<span>Customer</span></div>
                                    </div>
                        ...
                        <div class="item">
                            <div class="gradient-white-top p-40 py-4 rounded-1">
                                <blockquote>
                                    <i class="fs-32 icofont-quote-left absolute start-0 mt-2 p-0 id-color"></i>
                                    <div class="de_testi_by">
                                        <img class="circle" alt="" src="https://madebydesignesia.com/themes/dentia/images/testimonial/2.webp"> <div>Robert L.<span>Customer</span></div>
                                    </div>
                        ...
                        <div class="item">
                            <div class="gradient-white-top p-40 py-4 rounded-1">
                                <blockquote>
                                    <i class="fs-32 icofont-quote-left absolute start-0 mt-2 p-0 id-color"></i>
                                    <div class="de_testi_by">
                                        <img class="circle" alt="" src="https://madebydesignesia.com/themes/dentia/images/testimonial/3.webp"> <div>Jake M.<span>Customer</span></div>
                                    </div>
                        ...
                        <div class="item">
                            <div class="gradient-white-top p-40 py-4 rounded-1">
                                <blockquote>
                                    <i class="fs-32 icofont-quote-left absolute start-0 mt-2 p-0 id-color"></i>
                                    <div class="de_testi_by">
                                        <img class="circle" alt="" src="https://madebydesignesia.com/themes/dentia/images/testimonial/4.webp"> <div>Alex P.<span>Customer</span></div>
                                    </div>
                        ...
                        <div class="item">
                            <div class="gradient-white-top p-40 py-4 rounded-1">
                                <blockquote>
                                    <i class="fs-32 icofont-quote-left absolute start-0 mt-2 p-0 id-color"></i>
                                    <div class="de_testi_by">
                                        <img class="circle" alt="" src="https://madebydesignesia.com/themes/dentia/images/testimonial/5.webp"> <div>Carlos R.<span>Customer</span></div>
                                    </div>
                        ...
                        <div class="item">
                            <div class="gradient-white-top p-40 py-4 rounded-1">
                                <blockquote>
                                    <i class="fs-32 icofont-quote-left absolute start-0 mt-2 p-0 id-color"></i>
                                    <div class="de_testi_by">
                                        <img class="circle" alt="" src="https://madebydesignesia.com/themes/dentia/images/testimonial/6.webp"> <div>Edward B.<span>Customer</span></div>
                                    </div>
                        ...
                        <div class="item">
                            <div class="gradient-white-top p-40 py-4 rounded-1">
                                <blockquote>
                                    <i class="fs-32 icofont-quote-left absolute start-0 mt-2 p-0 id-color"></i>
                                    <div class="de_testi_by">
                                        <img class="circle" alt="" src="https://madebydesignesia.com/themes/dentia/images/testimonial/7.webp"> <div>Daniel H.<span>Customer</span></div>
                                    </div>
                        ...
                        <div class="item">
                            <div class="gradient-white-top p-40 py-4 rounded-1">
                                <blockquote>
                                    <i class="fs-32 icofont-quote-left absolute start-0 mt-2 p-0 id-color"></i>
                                    <div class="de_testi_by">
                                        <img class="circle" alt="" src="https://madebydesignesia.com/themes/dentia/images/testimonial/8.webp"> <div>Bryan G.<span>Customer</span></div>
                                    </div>
